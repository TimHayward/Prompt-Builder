    ...
    >
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <p>
            Systematic method for structuring sectioned prompts for increased understanding. See a
            more in depth explanation{' '}
            <a href="https://github.com/falktravis/Prompt-Builder/discussions/1">here</a>.
          </p>
          <label className="settings-toggle">
            ...
            <Switch
              ...
              onChange={e =>
                setFormData({ ...formData, markdownPromptingEnabled: e.target.checked })
              }
              color="primary"
            />
          </label>
        ...
        <div className="form-group">
          <div className="system-prompt-header">
            ...
            <button className="reset-default-btn" type="button" onClick={handleResetSystemPrompt}>
              Reset to Default
            </button>
          </div>
          <textarea
